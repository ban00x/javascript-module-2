...
function presentation(arr) {
  arr.filter(writer => writer.alive === true).forEach(
    writer => console.log(`Hi, my name is ${writer.firstName} ${writer.lastName}. I am ${writer.age} years old, and work as a ${writer.occupation}`))
 }

console.log(presentation(writers))